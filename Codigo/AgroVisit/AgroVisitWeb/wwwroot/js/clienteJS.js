document.addEventListener('DOMContentLoaded', function () {
    const items = __INITIAL_DATA__; // Obtém os dados do Model
            ...
            container.append(`
                                <div id="border" class="col-10 card radius-10 border-start border-0 border-5 border-success m-3 ms-0"
                                    ...
                                    <div class="card-body row">
                                        ...
                                        <div class="row">
                                                    <a href="/Cliente/Details/${item.Id}" id="border" class="btn borda-concluir btn-outline-success col-3 m-2">Detalhes</a>
                                            <a href="/Cliente/Delete/${item.Id}" id="border" class="btn border-danger btn-danger col-3 m-2">Excluir</a>
                                        </div>
                                    </div>
                                </div>
                            `);
