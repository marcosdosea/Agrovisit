...
CREATE TABLE `intervencao` (
  ...
  CONSTRAINT `fkIntervencaoProjeto1` FOREIGN KEY (`idProjeto`) REFERENCES `projeto` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
...
INSERT INTO `intervencao` VALUES (3,'calda bordalesa','Dikuir a calda bordaleza, acrescentando mais 10 litros de agua (concentração de 0,5%). Evite aplicar em horários de sol quente.','2024-01-10','Fungicida',1,'EX',3);
